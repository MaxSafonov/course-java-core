...
class Task06 {
    ...
    static String getResult(int tanksKilledFirstPlayer, int tanksKilledSecondPlayer) {
        int pointFirstPlayer = tanksKilledFirstPlayer * KILL_POINT;
        int pointSecondPlayer = tanksKilledSecondPlayer * KILL_POINT;

        if (tanksKilledFirstPlayer > tanksKilledSecondPlayer) {
           int i = pointFirstPlayer + BONUS_POINT;
           return String.format("Player 1: %d. Player 2: %d", i, pointSecondPlayer);
        }  else if (tanksKilledFirstPlayer < tanksKilledSecondPlayer) {
            int j = pointSecondPlayer + BONUS_POINT;
            return String.format("Player 1: %d. Player 2: %d", pointFirstPlayer, j);
        } else if (tanksKilledFirstPlayer == tanksKilledSecondPlayer){
            return String.format("Player 1: %d. Player 2: %d", pointFirstPlayer, pointSecondPlayer);
        }
        return null;
    }
}
